...
function Contact() {
  const contacts = [
    ...
    { icon: <GithubIcon />,  label: "GitHub",   value: "github.com/Mithun9661", href: personalInfo.github, color: VIOLET },
    { icon: <LinkedinIcon />,label: "LinkedIn", value: "linkedin.com/in/mithun-kumar-bbaa66244/", href: personalInfo.linkedin, color: PINK },
